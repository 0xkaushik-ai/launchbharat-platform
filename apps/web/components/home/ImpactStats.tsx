...
/**
 * National impact strip — a calm white panel with a gradient hairline border
 * that overlaps the hero bottom. Values come from the CMS
...
export default function ImpactStats() {
  ...
  return (
    <section
      ...
      className="relative z-10 -mt-12 bg-white md:-mt-16"
    >
      ...
      <Container>
        <Reveal variant="panel">
          <div
            className="neo-border rounded-3xl px-6 py-10 shadow-[0_24px_54px_-38px_rgba(37,46,86,0.28)] sm:px-10 md:px-14 md:py-12"
            style={{ "--neo-bg": "rgba(255,255,255,0.96)" } as CSSProperties}
          >
